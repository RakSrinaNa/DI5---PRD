 ...
 * @since 2018-11-22
 */
public class TourTravelMetricEvent extends IdentifiableMetricEvent<ChargingStop, Charger>{
	public TourTravelMetricEvent(final double time, @NotNull final Charger charger, @NotNull final ChargingStop chargingStop){
