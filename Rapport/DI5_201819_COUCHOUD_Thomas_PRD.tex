...
\chapter{Analyse et conception}
	...
	\section{Analyse théorique}
		...
		\subsection{Modification de la méthode de clustering}
			...
			Actuellement la création de ces régions d'arrêt fait en sorte qu'un capteur se retrouve associé à un unique point d'arrêt.
			Cependant il peut être fortement intéressant de pouvoir attribuer plusieurs régions à un capteur.
			De cette manière on peut considérer le rechargement d'un capteur depuis plusieurs zones.
